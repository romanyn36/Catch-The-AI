...
export class TextDetector extends Component {
  ...
  fetchDetectionSystem = (mediaType) => {
    ...
    fetch(url, {
      ...
      .then(data => {
        console.log(data);
        this.setState({ result: data.result, isClicked: false });
  ...
  render() {
    const { selectedMediaType, pulsatingMediaType, result, isClicked } = this.state;
        ...
        <div className="container  MainContainer1  ">
          ...
          <div className="row w-100 mt-4 p-2">
            <div className="col-md-9 ">
              {selectedMediaType === 'Image' && (
                <div className="media-container">
                  ...
                  <input id="file-upload" type="file" style={{ display: "none" }} onChange={this.handleImageFile}/>
            ...
            <div className="col-md-3">
              ...
              <button className="btn btn-outline- submit-button mt-2 mb-2" disabled={isClicked} onClick={() => this.predict_media(pulsatingMediaType)}>AI or Human?</button>
            </div>
          </div>
        </div>
      </div>
